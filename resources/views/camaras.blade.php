...
<div class="section">
    ...
    <div class="gallery">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <img src="/img/secciones/camaras/camara1.jpg" alt="camara 1">
                </div>
                <div class="col-md-6">
                    <img src="/img/secciones/camaras/camara2.jpg" alt="camara 2">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <img src="/img/secciones/camaras/camara3.jpg" alt="camara 3">
                </div>
                <div class="col-md-6">
                    <img src="/img/secciones/camaras/camara4.jpg" alt="camara 4">
                </div>
            </div>
